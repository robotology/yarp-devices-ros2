...
bool Rangefinder2D_controlBoard_nws_ros2_ParamsParser::getParamValue(const std::string& paramName, std::string& paramValue) const
{
    if (paramName =="period")
    {
    ...
    {
        paramValue = m_topic_lidar;
        return true;
    }
    if (paramName =="topic_joint")
    {
        paramValue = m_topic_joint;
        return true;
    }
...
std::string Rangefinder2D_controlBoard_nws_ros2_ParamsParser::getConfiguration() const
{
