...
bool GenericSensor_nwc_ros2_ParamsParser::getParamValue(const std::string& paramName, std::string& paramValue) const
{
...
std::string GenericSensor_nwc_ros2_ParamsParser::getConfiguration() const
{
