...
bool      FrameTransformSet_nwc_ros2_ParamsParser::parseParams(const yarp::os::Searchable & config)
{
    ...
    //Parser of parameter ROS2::namespace
    {
        ...
        if (sectionp.check("namespace"))
        {
            ...
            yCInfo(FrameTransformSet_nwc_ros2ParamsCOMPONENT) << "Parameter 'ROS2::namespace' using value:" << m_ROS2_namespace;
        }
        else
        {
            yCInfo(FrameTransformSet_nwc_ros2ParamsCOMPONENT) << "Parameter 'ROS2::namespace' using DEFAULT value:" << m_ROS2_namespace;
        }
...
std::string      FrameTransformSet_nwc_ros2_ParamsParser::getDocumentationOfDeviceParams() const
{
    ...
    doc = doc + " yarpdev --device frameTransformSet_nwc_ros2 --GENERAL::refresh_interval 0.1 --GENERAL::period 0.01 --GENERAL::asynch_pub 1 --ROS2::ft_node tfNodeSet --ROS2::namespace <optional_value> --ROS2::ft_topic /tf --ROS2::ft_topic_static /tf_static\n";
