...
// Generated on: Fri Aug  2 12:16:31 2024
...
std::string      FrameTransformSet_nwc_ros2_ParamsParser::getDocumentationOfDeviceParams() const
{
    ...
    doc = doc + " yarpdev --device frameTransformSet_nwc_ros2 --GENERAL::refresh_interval 0.1 --GENERAL::period 0.01 --GENERAL::asynch_pub 1 --ROS2::ft_node /tfNodeGet --ROS2::ft_topic /tf --ROS2::ft_topic_static /tf_static\n";
