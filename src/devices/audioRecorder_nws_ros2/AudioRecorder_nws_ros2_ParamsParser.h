...
#ifndef AUDIORECORDER_NWS_ROS2_PARAMSPARSER_H
#define AUDIORECORDER_NWS_ROS2_PARAMSPARSER_H
...
/**
* This class is the parameters parser for class AudioRecorder_nws_ros2.
*
...
* \code{.unparsed}
* yarpdev --device audioRecorder_nws_ros2 --period 0.02 --node_name <mandatory_value> --topic_name <mandatory_value>
* \endcode
*
* \code{.unparsed}
* yarpdev --device audioRecorder_nws_ros2 --node_name <mandatory_value> --topic_name <mandatory_value>
* \endcode
*
*/

class AudioRecorder_nws_ros2_ParamsParser : public yarp::dev::IDeviceDriverParams
{
public:
    AudioRecorder_nws_ros2_ParamsParser();
    ~AudioRecorder_nws_ros2_ParamsParser() override = default;

public:
    const std::string m_device_classname = {"AudioRecorder_nws_ros2"};
    const std::string m_device_name = {"audioRecorder_nws_ros2"};
