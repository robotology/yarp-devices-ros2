...
* \code{.unparsed}
* yarpdev --device rgbdToPointCloudSensor_nws_ros2 --period 0.03 --topic_name <mandatory_value> --frame_id <mandatory_value> --node_name <mandatory_value> --namespace <optional_value>
* \endcode
*
* \code{.unparsed}
