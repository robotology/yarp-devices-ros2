...
bool Rangefinder2D_nws_ros2_ParamsParser::getParamValue(const std::string& paramName, std::string& paramValue) const
{
    if (paramName =="period")
    {
...
std::string Rangefinder2D_nws_ros2_ParamsParser::getConfiguration() const
{
...
bool      Rangefinder2D_nws_ros2_ParamsParser::parseParams(const yarp::os::Searchable & config)
{
    ...
    //Parser of parameter namespace
    {
        if (config.check("namespace"))
        {
            ...
            yCInfo(Rangefinder2D_nws_ros2ParamsCOMPONENT) << "Parameter 'namespace' using value:" << m_namespace;
        }
        else
        {
            yCInfo(Rangefinder2D_nws_ros2ParamsCOMPONENT) << "Parameter 'namespace' using DEFAULT value:" << m_namespace;
        }
...
std::string      Rangefinder2D_nws_ros2_ParamsParser::getDocumentationOfDeviceParams() const
{
    ...
    doc = doc + " yarpdev --device rangefinder2D_nws_ros2 --period 0.02 --node_name <mandatory_value> --namespace <optional_value> --topic_name <mandatory_value> --frame_id laser_frame\n";
