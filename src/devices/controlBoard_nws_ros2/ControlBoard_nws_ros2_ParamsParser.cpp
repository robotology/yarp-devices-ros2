...
namespace {
    YARP_LOG_COMPONENT(ControlBoard_nws_ros2ParamsCOMPONENT, "yarp.device.ControlBoard_nws_ros2")
}
...
std::vector<std::string> ControlBoard_nws_ros2_ParamsParser::getListOfParams() const
{
...
bool ControlBoard_nws_ros2_ParamsParser::getParamValue(const std::string& paramName, std::string& paramValue) const
{
    ...
    if (paramName =="msgs_name")
    {
        paramValue = m_msgs_name;
        return true;
    }
    if (paramName =="period")
    {
...
std::string ControlBoard_nws_ros2_ParamsParser::getConfiguration() const
{
...
bool      ControlBoard_nws_ros2_ParamsParser::parseParams(const yarp::os::Searchable & config)
{
    //Check for --help option
    if (config.check("help"))
    {
        yCInfo(ControlBoard_nws_ros2ParamsCOMPONENT) << getDocumentationOfDeviceParams();
    }
    ...
    //Parser of parameter node_name
    {
        if (config.check("node_name"))
        {
            ...
            yCInfo(ControlBoard_nws_ros2ParamsCOMPONENT) << "Parameter 'node_name' using value:" << m_node_name;
        }
        else
        {
            yCError(ControlBoard_nws_ros2ParamsCOMPONENT) << "Mandatory parameter 'node_name' not found!";
            yCError(ControlBoard_nws_ros2ParamsCOMPONENT) << "Description of the parameter: set the name for ROS node";
            return false;
        }
    ...
    //Parser of parameter topic_name
    {
        if (config.check("topic_name"))
        {
            ...
            yCInfo(ControlBoard_nws_ros2ParamsCOMPONENT) << "Parameter 'topic_name' using value:" << m_topic_name;
        }
        else
        {
            yCError(ControlBoard_nws_ros2ParamsCOMPONENT) << "Mandatory parameter 'topic_name' not found!";
            yCError(ControlBoard_nws_ros2ParamsCOMPONENT) << "Description of the parameter: set the name for ROS topic";
            return false;
        }
        prop_check.unput("topic_name");
    }

    //Parser of parameter msgs_name
    {
        if (config.check("msgs_name"))
        {
            m_msgs_name = config.find("msgs_name").asString();
            yCInfo(ControlBoard_nws_ros2ParamsCOMPONENT) << "Parameter 'msgs_name' using value:" << m_msgs_name;
        }
        else
        {
            yCInfo(ControlBoard_nws_ros2ParamsCOMPONENT) << "Parameter 'msgs_name' using DEFAULT value:" << m_msgs_name;
        }
        prop_check.unput("msgs_name");
    }
    ...
    //Parser of parameter period
    {
        if (config.check("period"))
        {
            ...
            yCInfo(ControlBoard_nws_ros2ParamsCOMPONENT) << "Parameter 'period' using value:" << m_period;
        }
        else
        {
            yCInfo(ControlBoard_nws_ros2ParamsCOMPONENT) << "Parameter 'period' using DEFAULT value:" << m_period;
        }
    ...
    if (prop_check.size() > 0)
    {
        ...
        for (auto it=prop_check.begin(); it!=prop_check.end(); it++)
        {
            ...
            {
                yCError(ControlBoard_nws_ros2ParamsCOMPONENT) << "User asking for parameter: "<<it->name <<" which is unknown to this parser!";
                extra_params_found = true;
            }
            else
            {
                yCWarning(ControlBoard_nws_ros2ParamsCOMPONENT) << "User asking for parameter: "<< it->name <<" which is unknown to this parser!";
            }
        }
...
std::string      ControlBoard_nws_ros2_ParamsParser::getDocumentationOfDeviceParams() const
{
    std::string doc;
    doc = doc + std::string("\n=============================================\n");
    doc = doc + std::string("This is the help for device: ControlBoard_nws_ros2\n");
    doc = doc + std::string("\n");
