...
bool      HapticDevice_nws_ros2_ParamsParser::parseParams(const yarp::os::Searchable & config)
{
    ...
    //Parser of parameter namespace
    {
        if (config.check("namespace"))
        {
            ...
            yCInfo(HapticDevice_nws_ros2ParamsCOMPONENT) << "Parameter 'namespace' using value:" << m_namespace;
        }
        else
        {
            yCInfo(HapticDevice_nws_ros2ParamsCOMPONENT) << "Parameter 'namespace' using DEFAULT value:" << m_namespace;
        }
