...
bool MobileBaseVelocityControl_nws_ros2_ParamsParser::getParamValue(const std::string& paramName, std::string& paramValue) const
{
...
std::string MobileBaseVelocityControl_nws_ros2_ParamsParser::getConfiguration() const
{
...
bool      MobileBaseVelocityControl_nws_ros2_ParamsParser::parseParams(const yarp::os::Searchable & config)
{
    ...
    //Parser of parameter namespace
    {
        if (config.check("namespace"))
        {
            ...
            yCInfo(MobileBaseVelocityControl_nws_ros2ParamsCOMPONENT) << "Parameter 'namespace' using value:" << m_namespace;
        }
        else
        {
            yCInfo(MobileBaseVelocityControl_nws_ros2ParamsCOMPONENT) << "Parameter 'namespace' using DEFAULT value:" << m_namespace;
        }
...
std::string      MobileBaseVelocityControl_nws_ros2_ParamsParser::getDocumentationOfDeviceParams() const
{
    ...
    doc = doc + " yarpdev --device mobileBaseVelocityControl_nws_ros2 --node_name <mandatory_value> --namespace <optional_value> --topic_name <mandatory_value>\n";
