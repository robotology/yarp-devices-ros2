...
bool RgbdSensor_nwc_ros2_ParamsParser::getParamValue(const std::string& paramName, std::string& paramValue) const
{
...
std::string RgbdSensor_nwc_ros2_ParamsParser::getConfiguration() const
{
...
bool      RgbdSensor_nwc_ros2_ParamsParser::parseParams(const yarp::os::Searchable & config)
{
    ...
    //Parser of parameter namespace
    {
        if (config.check("namespace"))
        {
            ...
            yCInfo(RgbdSensor_nwc_ros2ParamsCOMPONENT) << "Parameter 'namespace' using value:" << m_namespace;
        }
        else
        {
            yCInfo(RgbdSensor_nwc_ros2ParamsCOMPONENT) << "Parameter 'namespace' using DEFAULT value:" << m_namespace;
        }
...
std::string      RgbdSensor_nwc_ros2_ParamsParser::getDocumentationOfDeviceParams() const
{
    ...
    doc = doc + " yarpdev --device rgbdSensor_nwc_ros2 --node_name <mandatory_value> --namespace <optional_value> --color_topic_name <mandatory_value> --depth_topic_name <mandatory_value> --verbose_on 0\n";
