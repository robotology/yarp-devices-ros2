...
* \code{.unparsed}
* yarpdev --device frameGrabber_nws_ros2 --period 0.02 --node_name <mandatory_value> --namespace <optional_value> --topic_name <mandatory_value> --frame_id <mandatory_value>
* \endcode
*
* \code{.unparsed}
